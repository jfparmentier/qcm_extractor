...
final class Config
{
    ...
    private function __construct(
        ...
        public readonly int $backgroundStartTimeoutSeconds,
        public readonly int $backgroundPollTimeoutSeconds,
        public readonly int $backgroundPollIntervalMilliseconds,
        public readonly int $backgroundJobTtlSeconds,
        ...
        public readonly int $rateLimitLocalRequests,
        public readonly int $rateLimitExtractionRequests,
        public readonly int $rateLimitLocalExtractionRequests,
    ...
    public static function fromEnvironment(string $projectRoot): self
    {
        ...
        return new self(
            ...
            backgroundStartTimeoutSeconds: self::integer('QCM_BACKGROUND_START_TIMEOUT_SECONDS', 25, 5, 60),
            backgroundPollTimeoutSeconds: self::integer('QCM_BACKGROUND_POLL_TIMEOUT_SECONDS', 20, 5, 60),
            backgroundPollIntervalMilliseconds: self::integer('QCM_BACKGROUND_POLL_INTERVAL_MS', 2000, 500, 10000),
            backgroundJobTtlSeconds: self::integer('QCM_BACKGROUND_JOB_TTL_SECONDS', 900, 120, 3600),
            ...
            rateLimitLocalRequests: self::integer('QCM_RATE_LIMIT_LOCAL_REQUESTS', 100, 1, 10_000),
            rateLimitExtractionRequests: self::integer('QCM_RATE_LIMIT_EXTRACTION_REQUESTS', 40, 1, 10_000),
            rateLimitLocalExtractionRequests: self::integer('QCM_RATE_LIMIT_LOCAL_EXTRACTION_REQUESTS', 200, 1, 10_000),
