...
export function PdfViewer({ pdf, currentPage, zoom, onPageChange, onZoomIn, onZoomOut, onResetZoom, onClose }) {
    ...
    return (_jsxs("section", { className: "viewer-shell", "aria-label": "Visualiseur PDF", children: [_jsxs("header", { className: "document-header", children: [_jsxs("div", { className: "document-header__identity", children: [_jsx("span", { className: "document-header__icon", children: _jsx(FileIcon, {}) }), _jsxs("div", { className: "document-header__text", children: [_jsx("strong", { title: pdf.fileName, children: pdf.title ?? pdf.fileName }), _jsxs("span", { children: [pdf.pageCount, " page", pdf.pageCount > 1 ? "s" : "", " \u00B7 ", formatFileSize(pdf.fileSize), pdf.author !== null ? ` · ${pdf.author}` : ""] })] })] }), _jsxs("div", { className: "document-header__actions", children: [_jsx("span", { className: "local-badge", children: "Local" }), _jsx("button", { "aria-label": "Fermer le document", className: "icon-button icon-button--quiet", onClick: onClose, title: "Fermer le document", type: "button", children: _jsx(CloseIcon, {}) })] })] }), _jsx(PdfToolbar, { currentPage: currentPage, onPageChange: onPageChange, onResetZoom: onResetZoom, onZoomIn: onZoomIn, onZoomOut: onZoomOut, pageCount: pdf.pageCount, zoom: zoom }), _jsxs("div", { className: "viewer-layout", children: [_jsxs("aside", { className: "thumbnail-sidebar", "aria-label": "Miniatures des pages", children: [_jsxs("div", { className: "thumbnail-sidebar__heading", children: [_jsx("span", { children: "Pages" }), _jsx("span", { children: pdf.pageCount })] }), _jsx("nav", { className: "thumbnail-list", "aria-label": "Navigation par page", children: pageNumbers.map((pageNumber) => (_jsx(PdfThumbnail, { document: pdf.document, onSelect: onPageChange, pageNumber: pageNumber, selected: pageNumber === currentPage }, pageNumber))) })] }), _jsxs("main", { className: "page-workspace", children: [renderError !== null && (_jsxs("div", { className: "inline-error", role: "alert", children: ["Une erreur est survenue pendant le rendu de la page : ", renderError] })), _jsx("div", { className: "page-stage", children: _jsx(PdfPageCanvas, { document: pdf.document, onRenderError: handleRenderError, pageNumber: currentPage, scale: zoom }) })] })] })] }));
}
