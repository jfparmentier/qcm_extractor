...
import { getSegmentDisplayName } from "../domain/documentMap.js?v=7.5.1";
import { mergeExtractionResults } from "../domain/extraction.js?v=7.5.1";
import { createReviewArchive, createReviewExport, createReviewQuestions, downloadBlob, exportFileName, reviewSourceFingerprint } from "../domain/review.js?v=7.5.1";
import { formatFileSize } from "../pdf/formatFileSize.js?v=7.5.1";
import { CloseIcon, FileIcon, SparklesIcon } from "./Icons.js?v=7.5.1";
import { ExtractionPanel } from "./ExtractionPanel.js?v=7.5.1";
import { IllustrationPanel } from "./IllustrationPanel.js?v=7.5.1";
import { MappingPanel } from "./MappingPanel.js?v=7.5.1";
import { PreparationPanel } from "./PreparationPanel.js?v=7.5.1";
import { PdfPageCanvas } from "./PdfPageCanvas.js?v=7.5.1";
import { PdfToolbar } from "./PdfToolbar.js?v=7.5.1";
import { QuestionReview } from "./QuestionReview.js?v=7.5.1";
...
export function PdfViewer({ pdf, currentPage, zoom, mapping, batching, extraction, illustrationPlan, illustrationGeneration, onAnalyze, onCancelMapping, onValidateMapping, onSelectSegment, onSelectRegion, onUpdateRegionBbox, onUpdateRegionRole, onAddRegion, onDeleteRegion, onDeleteSegment, onExtractAll, onCancelExtraction, onGenerateAllIllustrations, onGenerateIllustration, onCancelIllustrationGeneration, onClearIllustrations, onDownloadIllustration, onPageChange, onZoomIn, onZoomOut, onResetZoom, onClose }) {
