...
import { ChevronLeftIcon, ChevronRightIcon, MinusIcon, PlusIcon, ResetIcon } from "./Icons.js?v=7.4.0";
export function PdfToolbar({ currentPage, pageCount, zoom, onPageChange, onZoomIn, onZoomOut, onResetZoom }) {
