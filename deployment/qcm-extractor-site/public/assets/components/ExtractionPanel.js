...
export function ExtractionPanel({ documentMap, plan, extraction, onSettingsChange, onExtractAll, onExtractBatch, onCancel, onClear, onSelectSegment }) {
