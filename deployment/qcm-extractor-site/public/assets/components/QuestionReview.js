...
import { nextChoiceId, reviewQuestionIssues } from "../domain/review.js?v=7.3.1";
import { ChevronLeftIcon, ChevronRightIcon, DownloadIcon, ImageIcon, MinusIcon, PlusIcon, TrashIcon, WarningIcon } from "./Icons.js?v=7.3.1";
