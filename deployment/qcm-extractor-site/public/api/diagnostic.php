...
$payload = [
    ...
    'diagnostic' => [
        ...
        'extraction_model' => isset($runtime['QCM_OPENAI_EXTRACTION_MODEL']) ? (string) $runtime['QCM_OPENAI_EXTRACTION_MODEL'] : 'gpt-5',
        ...
        'rate_limit_backend' => isset($runtime['QCM_RATE_LIMIT_BACKEND']) ? (string) $runtime['QCM_RATE_LIMIT_BACKEND'] : 'file',
        'rate_limit_requests' => isset($runtime['QCM_RATE_LIMIT_REQUESTS']) ? (int) $runtime['QCM_RATE_LIMIT_REQUESTS'] : 10,
        'rate_limit_local_requests' => isset($runtime['QCM_RATE_LIMIT_LOCAL_REQUESTS']) ? (int) $runtime['QCM_RATE_LIMIT_LOCAL_REQUESTS'] : 100,
        'rate_limit_extraction_requests' => isset($runtime['QCM_RATE_LIMIT_EXTRACTION_REQUESTS']) ? (int) $runtime['QCM_RATE_LIMIT_EXTRACTION_REQUESTS'] : 40,
        'rate_limit_local_extraction_requests' => isset($runtime['QCM_RATE_LIMIT_LOCAL_EXTRACTION_REQUESTS']) ? (int) $runtime['QCM_RATE_LIMIT_LOCAL_EXTRACTION_REQUESTS'] : 200,
        'rate_limit_window_seconds' => isset($runtime['QCM_RATE_LIMIT_WINDOW_SECONDS']) ? (int) $runtime['QCM_RATE_LIMIT_WINDOW_SECONDS'] : 3600,
