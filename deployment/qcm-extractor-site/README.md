# Dossier de déploiement OVH / MAMP — Phase 5.0.1
...
La cartographie et l’extraction détaillée sont asynchrones. Les PDF ne sont pas enregistrés par l’application ; seuls de petits compteurs de limitation de débit et un journal technique non sensible peuvent être écrits sous `private/runtime`.
